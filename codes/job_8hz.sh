...
! Fixed time step,                     If fixed, set dt.
  fixed_time_step=.TRUE.             dt=1.953125d-5
!
...
! If ParaView,               Format,                Loop Frequency,          Time interval (s),             Prefix.
  paraview_output=.TRUE.    paraview_format="vtk"   paraview_frequency=0    paraview_time_interval=0.00390625d0   paraview_file_prefix="emu_8hz"
!
! If tecplot,                Loop Frequency,        Time interval (s),        Prefix.
  tecplot_output=.FALSE.     tecplot_frequency=50  tecplot_time_interval=0.0d0   tecplot_file_prefix="emu_8hz"
!
! If interface,              Format (raw/stl)         Loop Frequency,        Time interval (s),        Prefix.
  interface_output=.FALSE.    interface_format="stl"   interface_frequency=10   interface_time_interval=0.0d0    interface_file_prefix="emu_8hz"
!
! If history,         Loop Frequency,        Time interval (s),        Prefix.
  history_output=.TRUE.     history_frequency=1   history_time_interval=0.0d0   history_file_prefix="emu_8hz"
                      !                       X,          Y,          Z
...
! If signal,          Number of points,      Loop Frequency,      Time interval (s),     Prefix,
  signal_output=.FALSE.     num_signal_points=1   signal_frequency=1  signal_time_interval=0.0d0 signal_file_prefix="emu_8hz"
                                   !   X,       Y,       Z
...
! If shape,           Number of points,      Frequency,             Prefix,
  shape_output=.FALSE.      num_shape_points=1    shape_frequency=1  shape_time_interval=0.0d0   shape_file_prefix="emu_8hz"
                                  !   X,       Y,       Z
...
! Restart Output Frequency,   Output time interval (s)      Output File Prefix.
  output_restart_frequency=0     output_restart_time_interval=0.00390625d0     output_restart_file_prefix="emu_8hz"
!
! Restart (true/false),        Input File Index,        Input File Prefix.
  restart=.TRUE.              input_file_index=518       input_file_prefix="emu_8hz"
!--------------------------------------------------------------------------------------------------------------------------------  
/
EOF
